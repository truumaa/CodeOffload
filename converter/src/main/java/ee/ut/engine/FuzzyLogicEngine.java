...
public class FuzzyLogicEngine {
	 ...
	 * @param args
	 */
	public static double calculateFuzzyGrade(Map<String, Double> params)  throws FunctionException {
		...
		for(String key : params.keySet()){
			bfc.fuzzify(key, params.get(key));
		}
		
		/*
		//Here input to value is introduced
		bfc.fuzzify("BANDWIDTH", args[0]); //100  
		bfc.fuzzify("CPULOAD", args[1]); //10
		bfc.fuzzify("CONNECTIONS", args[2]); //150
	     */
