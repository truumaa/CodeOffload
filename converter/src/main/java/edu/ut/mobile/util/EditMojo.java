...
public class EditMojo {
	...
	private static final String FUNCTION_LIST_FILE_NAME = "testData";
    ...
    public static class Finder extends SimpleFileVisitor<Path> {
        ...
        private ArrayList<String> getFunctionNamesFromFile() {
            ArrayList<String> functionNames = new ArrayList<String>();
            File file = new File(FUNCTION_LIST_FILE_NAME);
            BufferedReader bf;
            try {
        ...
        public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) {
            ...
            if (file.toString().endsWith(".java")) {
                ...
                //Search for the function name in a list
                ...
                ArrayList<String> functionNamesList = getFunctionNamesFromFile();
                StringBuilder functionNames = new StringBuilder();
                for(String name : functionNamesList){
                ...
                Pattern pattern = Pattern.compile("\\s*((private)|(public)|(protected))+(\\s*\\w*)+("+functionNames.toString()+")\\s*\\((\\s*\\w*\\s{1,}\\w*\\s*(,)*)*\\)(\\s*\\w*)*\\{");
